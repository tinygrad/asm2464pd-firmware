...
static void u4c_sb_desc_commit(void) {
  ...
  /* e711 (CODE:e711, disasm-verified): reg0x35 = (LIVE reg35 & 0xC0); zero reg 0x3C,0x3D,0x3E,0x3F.
   * Was: reg35=(commit&0xC0) [commit has bit7] + only 0x3C/0x3D zeroed + bogus reg35=0/reg36=0 — that
   * left engine regs 0x3E/0x3F poisoned, so the descriptor-engine channel arm (SB[0x2C].4-7) under-
   * latched (0xC0 vs stock 0xF0). */
