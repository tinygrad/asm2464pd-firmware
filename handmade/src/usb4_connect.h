...
static void u4c_bcf2(void) { PR(0xCC3A) = (PR(0xCC3A) & 0xFD) | 0x02; PR(0xCC38) = (PR(0xCC38) & 0xFD) | 0x02; }
static void u4c_bd41(void) { PR(0xCC3B) &= 0xFD; }
static void u4c_bd14(void) { PR(0xCC3A) &= 0xFD; PR(0xCC38) &= 0xFD; }
...
static void bank0_8a89(uint8_t mode) {
  ...
  if (a9d < 3) {                                  /* the WHOLE engine gates on mode < 3 */
    ...
    PR(0x0A9F) = PR(0xE710) & 0x1F;
    PR(0x0A9F) = (PR(0xE710) & 0xE0) | 0x1F;
    PR(0x0A9E) = PR(0xCA06) >> 5;
    PR(0x0A9E) = (PR(0xCA06) & 0x1F) | 0x80;
    ...
    if (aa0 & 0x01) {                             /* 0x0AA0.0 -> arm E751 (USB4 link arm) */
      ...
      PR(0xE751) = 0x01;                           /* *** E751 = 1 (USB4 LINK ARM) *** */
    ...
    if (PR(0x0A9D) == 0x02) {
      if (aa0 & 0x02) {                            /* 0x0AA0.1 */
        PR(0x0A9D) = (PR(0xE716) & 0xFC);          /* 0x0A9D = bd50() */
    ...
    { uint32_t guard = 0;
      while (u4c_bd6c() != 0 && ++guard < 200000UL) {
        if (PR(0xC80A) & 0x40) pd_rx_isr();         /* C80A.6 -> af5e() == pd_rx_isr() */
        /* break on link-complete (0x0AE3==0 && CC33.2) OR connect-aborted (0x07ED==0) */
        if ((PR(0x0AE3) == 0 && (PR(0xCC33) >> 2 & 1)) || PR(0x07ED) == 0) break;
      }
    }

    /* tail */
    if ((aa0 & 0x08) && ((int8_t)PR(0xCC3D) < 0)) {  /* 0x0AA0.3 && CC3D.7 */
    ...
    PR(0xE764) = (PR(0xE764) & 0xEF) | 0x10;
    /* re-latch link rate into 0x0A9F/0x0A9E (final) */
    PR(0x0A9F) = PR(0x0A9F) | (PR(0xE710) & 0xE0);  /* bVar5 | bd49() */
    PR(0x0A9E) = (PR(0xCA06) & 0x1F) | (uint8_t)(PR(0x0A9E) << 5);  /* bd57() | (0x0A9E<<5) */
    PR(0xCA81) &= 0xFE;

    /* SECOND mode dispatch -> dd42(uVar2) */
    if (PR(0x0A9D) == 0x02) {
      if (aa0 & 0x02) {
        PR(0x0A9D) = (PR(0xE716) & 0xFC) | 0x03;    /* bd50() | 3 */
        PR(0x0A9E) = (PR(0xCC3E) & 0xFD);           /* (0x0A9D+1 store) bd33() */
      ...
      if (aa0 & 0x02) {
        ...
        { uint16_t g = 0;
          while (!((PR(0xE712) & 1) || (PR(0xE712) & 2)) && ++g < 0x4000); }
        PR(0xCC3B) &= 0xBF;
    ...
    if (PR(0x07ED) == 0) {
      ...
      if (cv == 0) {
        PR(0xCC3E) = (PR(0xCC3E) & 0xFD) | 0x02;     /* bce7(bd33()|2 -> store): CC3E bit1 + E717.0 */
        PR(0xE717) = (PR(0xE717) & 0xFE) | 0x01;
        PR(0xCC36) &= 0xDF;
      }
      U4C_BD23(0x92C4);                              /* bd23(92C4): set bit5 */
      if (cv == 0) {
        PR(0x92C4) = (PR(0xCC3E) & 0xFD);            /* store bd33() */
        U4C_BD23(0xCC36);
      }
      PR(0x92C4) &= 0xDF;
...
static void bank0_c9a8(uint8_t arg) {
  ...
  if (PR(0x09FA) & 0x04) {                          /* 0x09FA.2 */
    ...
    if ((PR(0x0AF1) & 0x01) &&
      ...
      PR(0xC6A8) &= 0xFE;                            /* C6A8 &= ~1 (545c side then this) */
